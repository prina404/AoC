...
public class Monkey implements Iterable<Long> {
    ...
    /*
     * Note: in modList there is 23 as last element, it was an erroneous leftover
     *  from the example modList.
     * 
     * It should produce the wrong answer on the correct input (test is never 23)
     *  BUT it doesn't: removing it produces the wrong answer instead. Why?
     */
